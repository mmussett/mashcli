...
func TestGetCollection(t *testing.T) {
	...
	var m *[]SystemHostnames

	m, err = GetCollection(tok, &mashcli.Params{Fields: SYSTEMHOSTNAMES_ALL_FIELDS})
...
func TestShowAllSystemHostnames(t *testing.T) {
	...
	err = ShowAllSystemHostnames(tok)
